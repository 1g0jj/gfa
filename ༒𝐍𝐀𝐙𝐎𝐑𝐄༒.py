...
if now >=target:print("سلام عليكم اول ادات بسمي وبسم القنات انشالله تقوم بعجابكم المطور @qqaqg")
...
print(output)
print(' نورت الدات حياتي 🗿🚬. ')
print(' هلا بيك في ادات صيد فيسبوك عن طريق ملف ايديات 🗿🚬.')
print(' @qqaqg ')
        ...
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                if 'ya' in oprek:
                    ...
                    print('\n')
                    statuscp = f'''DECODE BY DEMO | @D_E_M_O
                    ليس شغال 💀💔
لاتنسئ صور صيد 🙈
━━━━━━━━⚚𝐍𝐀𝐙𝐎𝐑𝐄⚚━━━━━━━━━━━━━━
جميل 👤 - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
...
━━━━━━━━⚚𝐍𝐀𝐙𝐎𝐑𝐄⚚━━━━━━━━━━━━━━
 🤪 @qqaqg                    
                ...
                if 'no' in taplikasi:
                    ...
                    print('\n')
                    statusok = f'''DECODE BY DEMO | @D_E_M_O
...
⚚𝐒𝐀𝐖𝐀𝐃⚚​​​​​ : https://www.facebook.com/profile.php?id={idf}
 ...
 💃🏽 @qqaqg
                    ...
                    infoakun += f'''DECODE BY DEMO | @D_E_M_O
                    شغـال 🥶🔥
━━━━━━━━⚚𝐍𝐀𝐙𝐎𝐑𝐄⚚━━━━━━━━━━━━━━━━━━━━━                     
...
@qqaqg '''
                    ...
                    print('\n')
                    statusok = f'''DECODE BY DEMO | @qqaqg                    
👤 - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n✏️ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
🗿 - COOKIES  : {kuki}\n{infoakun}                    
                    '''
                    statusok1 = nel(statusok, style='green')
